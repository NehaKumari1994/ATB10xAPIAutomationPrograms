package com.oswaldweenie.ex06_PATCH_Request;
...
public class APITesting001_PATCH_NonBDDStyle {
    //payload will be less and method will change(when compared to put)
